...
class RotatedFocalTeacher(RotatedSemiDetector):
    def __init__(self, model: dict, semi_loss, train_cfg=None, test_cfg=None, symmetry_aware=False,
        ...
        super(RotatedFocalTeacher, self).__init__(
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedFocalTeacher, self).forward_train(imgs, img_metas, **kwargs)
        ...
        if self.iter_count > self.burn_in_steps:
            ...
            with torch.no_grad():
                ...
                teacher_logits = self.teacher.forward_train(
                    get_data=True, **format_data['unsup_weak'], get_pred=False)
            # get student data
            ...
            unsup_losses = self.semi_loss(teacher_logits, student_logits, format_data['unsup_strong']['gt_labels'], self.iter_count, 
                                          self.CLASSES, ratio=self.region_ratio, img_metas=img_metas_unsup)
